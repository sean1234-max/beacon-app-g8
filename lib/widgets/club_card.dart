  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, regSnap) {
        final int liveCount = regSnap.data?.docs.length ?? club.memberCount;
        final bool isFull = liveCount >= club.maxMembers;
        final bool isOpen = club.recruitmentOpen && !isFull;
        final double progress = club.maxMembers > 0
            ? (liveCount / club.maxMembers).clamp(0.0, 1.0)
            : 0.0;
